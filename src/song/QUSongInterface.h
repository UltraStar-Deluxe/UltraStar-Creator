...
class QUSongInterface: public QObject {
	...
	Q_PROPERTY(QString mp3 READ mp3 CONSTANT)
	Q_PROPERTY(QString bpm READ bpm CONSTANT)
	Q_PROPERTY(QString gap READ gap CONSTANT)
	Q_PROPERTY(QString video READ video CONSTANT)
	Q_PROPERTY(QString videogap READ videogap CONSTANT)
	Q_PROPERTY(QString cover READ cover CONSTANT)
	Q_PROPERTY(QString background READ background CONSTANT)
	Q_PROPERTY(QString start READ start CONSTANT)
	Q_PROPERTY(QString language READ language CONSTANT)
	Q_PROPERTY(QString relative READ relative CONSTANT)
	...
	Q_PROPERTY(QString end READ end CONSTANT)
	Q_PROPERTY(QString creator READ creator CONSTANT)
	Q_PROPERTY(QString encoding READ encoding CONSTANT)
	Q_PROPERTY(QString previewstart READ previewstart CONSTANT)
	Q_PROPERTY(QString calcmedley READ calcmedley CONSTANT)
	Q_PROPERTY(QString medleystartbeat READ medleystartbeat CONSTANT)
	Q_PROPERTY(QString medleyendbeat READ medleyendbeat CONSTANT)
	Q_PROPERTY(QString p1 READ p1 CONSTANT)
	Q_PROPERTY(QString p2 READ p2 CONSTANT)
	Q_PROPERTY(QString album READ album CONSTANT)
	Q_PROPERTY(QString comment READ comment CONSTANT)
	Q_PROPERTY(QString source READ source CONSTANT)
	Q_PROPERTY(QString artistonsorting READ artistonsorting CONSTANT)
	Q_PROPERTY(QString titleonsorting READ titleonsorting CONSTANT)
	...
	Q_PROPERTY(QString txt READ txt CONSTANT)
	Q_PROPERTY(QString lengthTotal READ lengthEffectiveFormatted CONSTANT)
	Q_PROPERTY(QString speed READ speedFormatted CONSTANT)
	Q_PROPERTY(QString titlecompact READ titleCompact CONSTANT)
	// boolean properties
	Q_PROPERTY(bool hasMp3 READ hasMp3 CONSTANT)
	Q_PROPERTY(bool hasCover READ hasCover CONSTANT)
	Q_PROPERTY(bool hasBackground READ hasBackground CONSTANT)
	Q_PROPERTY(bool hasVideo READ hasVideo CONSTANT)
	Q_PROPERTY(bool hasMedley READ hasMedley CONSTANT)
	Q_PROPERTY(bool hasGoldenNotes READ hasGoldenNotes CONSTANT)
	Q_PROPERTY(bool hasRapNotes READ hasRapNotes CONSTANT)
	Q_PROPERTY(bool isSongChecked READ isSongChecked CONSTANT)
	Q_PROPERTY(bool isDuet READ isDuet CONSTANT)
	Q_PROPERTY(bool isKaraoke READ isKaraoke CONSTANT)
	Q_PROPERTY(bool isSingStar READ isSingStar CONSTANT)
	Q_PROPERTY(bool isRockBand READ isRockBand CONSTANT)
