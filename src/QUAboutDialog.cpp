...
QUAboutDialog::QUAboutDialog(QWidget *parent): QDialog(parent) {
	...
	creditsText += "<br>Markus B&ouml;hning<br><br>";
	...
	creditsText += "<br>Marcel Taeumel<br>Markus B&ouml;hning";
	creditsText += "<br><br>***<br><br>";
	...
	versionLbl->setText(QString(tr("Version: <b>%1</b><br>Date: %2")).arg(QString(revision), dateTime.toString("yyyy-MM-dd, HH:mm")));
