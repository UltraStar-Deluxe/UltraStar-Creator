...
void QUMonty::initMessages() {
    ...
    messages << QObject::tr("The song is too fast for you and you can't keep up with the tapping?? Don't worry, you can change the playback speed under <i>Options &rarr; Playback speed</i>.");
    ...
    messages << QObject::tr("UltraStar Creator offers automatic syllabification for English, German, and Spanish songs. Although this feature is not perfect, it can save you a lot of time and you only need to change the result here and there.");
    messages << QObject::tr("Did you tap a few syllables too much? No problem, just hit the little undo arrow to the left of the tap button or simply press <i>X</i> to undo the last tap while simultaneously rewinding the audio by a second.");
    ...
    messages << QObject::tr("Screwed up and want to start over? Just stop tapping by clicking on the Stop and the on the Rewind button. Or simply press <i>S</i> and then <i>R</i>.");
